...
const Searchresult = () => {
  const { searchResults, } = useContext(createContextProvider);
  ...
  const [activeBrand, setActiveBrand] = useState(null); // Define activeBrand state
  const [activeRating, setActiveRating] = useState(null); // Define activeRating state
  const [filteredResults, setFilteredResults] = useState(searchResults);

  // Apply filtering when minPrice, maxPrice, or searchResults change
  useEffect(() => {
  ...
  }, [searchResults, minPrice, maxPrice, sortBy, activeBrand, activeRating]);
  ...
  return (
    <div className="px-3 lg:px-0 container mx-auto py-10">
      ...
      <div className="flex justify-center mt-4">
        {/* Render PaginationComponent with props */}
        <PaginationComponent
