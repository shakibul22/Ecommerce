const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-[#C1DCDC] pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <h2 className=" font-bold text-2xl">GREENMIND</h2>

                <p className="my-7 text-base text-body-color dark:text-dark-6">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; 2023 all Right Reserved Term of use GREENMIND
                </p>
              </div>
            </div>
          </div>
